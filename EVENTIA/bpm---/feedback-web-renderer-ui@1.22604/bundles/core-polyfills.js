(function() {
    ...
    // Nashorn ~ JDK8 bug
    var NASHORN_BUG =
        getOwnPropertyDescriptor && !nativePropertyIsEnumerable.call({
            1: 2
        }, 1);
    ...
    var f$1 = descriptors ?
        ...
        function getOwnPropertyDescriptor(O, P) {
            ...
            if (has(O, P))
                return createPropertyDescriptor(!objectPropertyIsEnumerable.f.call(O, P),
                    O[P]
                );
        };
