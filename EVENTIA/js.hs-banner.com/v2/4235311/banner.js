...
_hsp.push(['addCookieDomain', '.eventtia.com']);
...
! function(e) {
    ...
    n.p = "//static.hsappstatic.net/cookie-banner-js/static-1.2131/";
    n(n.s = 4)
}([function(e, t, n) {
    var o;
                ...
                for (t = 0; t < l.length; t++) {
                    ...
                    if (h = e.attributes[d]) {
                        ...
                        if (this.config.protocols[a] && this.config.protocols[a][d]) {
                            ...
                            f = (_ = h.value.toLowerCase().match(s.REGEX_PROTOCOL)) ? -1 != n(_[1], g) : -1 != n(s.RELATIVE, g)
                        }
                        if (f) {
        ...
        function c(e) {
            ...
            for (t = 0; t < this.transformers.length; t++)
                if (null != (s = this.transformers[t]({
                    ...
                    s.attr_whitelist && (r.attr_whitelist = o(r.attr_whitelist, s.attr_whitelist));
    ...
    var h = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)((?:file|https?|blob|chrome|webpack|resource|\[native).*?|[^@]*bundle)(?::(\d+))?(?::(\d+))?\s*$/i,
    ...
    var f = /^\s*at (?:((?:\[object object\])?[^\\/]+(?: \[as \S+\])?) )?\(?(.*?):(\d+)(?::(\d+))?\)?\s*$/i;
    ...
    class G {
        ...
        test(e, t, n, o) {
            ...
            const s = this.targetedCountries.length > 0 || this.targetedRegions.length > 0,
                r = void 0 !== t && this.targetedCountries.includes(t),
                a = t && n ? `${t}-${n}` : void 0,
                c = void 0 !== a && this.targetedRegions.includes(a);
            return !s || r || c ? [this.wildcard ? 0 : 1, c ? 1 : 0, r ? 1 : 0, i] : R
        }
        static fromJS(e) {
            const {
    ...
    const H = new V.a({
            ...
            protocols: {
                a: {
                    href: ["http", "https", "mailto", V.a.ALL]
                },
                blockquote: {
                    cite: ["http", "https", V.a.RELATIVE]
                },
                q: {
                    cite: ["http", "https", V.a.RELATIVE]
                }
    ...
    class q {
        ...
        static fromJS(e) {
            return new q(e.acceptAllLabel, e.saveSettingsLabel, $.fromJS(e.introduction), $.fromJS(e.categories.necessary), $.fromJS(e.categories.analytics), $.fromJS(e.categories.advertisement), $.fromJS(e.categories.functionality))
        }
        getSanitizedText() {
            return new q(z(this.acceptLabel), z(this.saveSettingsLabel), this.introduction.getSanitizedText(), this.necessary.getSanitizedText(), this.analytics.getSanitizedText(), this.advertisement.getSanitizedText(), this.functionality.getSanitizedText())
        }
    }
    class K {
        ...
        static fromJS(e) {
            return new K(e.notification, e.acceptLabel, e.declineLabel, e.disclaimer, e.modalText && e.modalText.cookieSettingsLabel, e.modalText && q.fromJS(e.modalText))
        }
        getSanitizedText() {
            return new K(z(this.notification), z(this.acceptLabel), z(this.declineLabel), z(this.disclaimer), this.cookieSettingsLabel && z(this.cookieSettingsLabel), this.modalText && this.modalText.getSanitizedText())
        }
    }
    var j;
    class J {
    ...
    class X {
        ...
        static fromJS(e) {
            ...
            return new X(t, n, o, i, G.fromJS(s), Q.fromJS(r), F.fromJS(a), Z.fromJS(c))
        }
        withSanitizedPolicy() {
            return new X(this.id, this.portalId, this.label, this.enabled, this.configuration, this.policy.getSanitizedPolicy(), this.customizationSettings, this.gpcSettings)
        }
    ...
    function Se(e, t, n) {
        ...
        if (arguments.length > 2 && (r.children = arguments.length > 3 ? ue.call(arguments, 2) : n), "function" == typeof e && null != e.defaultProps)
    ...
    function Ie(e) {
        (!e.__d && (e.__d = !0) && fe.push(e) && !Ae.__r++ || pe !== ge.debounceRendering) && ((pe = ge.debounceRendering) || me)(Ae)
    }

    function Ae() {
        for (var e; Ae.__r = fe.length;) e = fe.sort((function(e, t) {
            return e.__v.__b - t.__v.__b
        })), fe = [], e.some((function(e) {
            var t, n, o, i, s, r;
            e.__d && (s = (i = (t = e).__v).__e, (r = t.__P) && (n = [], (o = Ce({}, i)).__v = i.__v + 1, Ue(r, i, o, t.__n, void 0 !== r.ownerSVGElement, null != i.__h ? [s] : null, n, null == s ? Oe(i) : s, i.__h), Fe(n, i), i.__e != s && Ee(i)))
        }))
    }

    function Le(e, t, n, o, i, s, r, a, c, l) {
        var h, d, u, g, _, f, m, p = o && o.__k || ye,
            b = p.length;
        for (n.__k = [], h = 0; h < t.length; h++)
            if (null != (g = n.__k[h] = null == (g = t[h]) || "boolean" == typeof g ? null : "string" == typeof g || "number" == typeof g || "bigint" == typeof g ? we(null, g, null, null, g) : Array.isArray(g) ? we(Te, {
                    children: g
                }, null, null, null) : g.__b > 0 ? we(g.type, g.props, g.key, null, g.__v) : g)) {
                ...
                Ue(e, g, u = u || be, i, s, r, a, c, l), _ = g.__e, (d = g.ref) && u.ref != d && (m || (m = []), u.ref && m.push(u.ref, null, g), m.push(d, g.__c || _, g)), null != _ ? (null == f && (f = _), "function" == typeof g.type && g.__k === u.__k ? g.__d = c = Ne(g, c, e) : c = Be(e, g, u, p, _, c), "function" == typeof n.type && (n.__d = c)) : c && u.__e == c && c.parentNode != e && (c = Oe(u))
            }
        for (n.__e = f, h = b; h--;) null != p[h] && ("function" == typeof n.type && null != p[h].__e && p[h].__e == n.__d && (n.__d = Oe(o, h + 1)), He(p[h], p[h]));
        if (m)
            for (h = 0; h < m.length; h++) Ve(m[h], m[++h], m[++h])
    }

    function Ne(e, t, n) {
        for (var o, i = e.__k, s = 0; i && s < i.length; s++)(o = i[s]) && (o.__ = e, t = "function" == typeof o.type ? Ne(o, t, n) : Be(n, o, o, i, o.__e, t));
        return t
    }
    ...
    function Re(e, t, n, o, i) {
        var s;
        for (s in n) "children" === s || "key" === s || s in t || De(e, s, null, n[s], o);
        for (s in t) i && "function" != typeof t[s] || "children" === s || "key" === s || "value" === s || "checked" === s || n[s] === t[s] || De(e, s, t[s], n[s], o)
    }

    function Pe(e, t, n) {
        "-" === t[0] ? e.setProperty(t, n) : e[t] = null == n ? "" : "number" != typeof n || ve.test(t) ? n : n + "px"
    }
    ...
    function De(e, t, n, o, i) {
        ...
        e: if ("style" === t)
            if ("string" == typeof n) e.style.cssText = n;
                ...
                if (n)
                    for (t in n) o && n[t] === o[t] || Pe(e.style, t, n[t])
            }
        else if ("o" === t[0] && "n" === t[1]) s = t !== (t = t.replace(/Capture$/, "")), t = t.toLowerCase() in e ? t.toLowerCase().slice(2) : t.slice(2), e.l || (e.l = {}), e.l[t + s] = n, n ? o || e.addEventListener(t, s ? Me : Ge, s) : e.removeEventListener(t, s ? Me : Ge, s);
    ...
    function Ue(e, t, n, o, i, s, r, a, c) {
        ...
        null != n.__h && (c = n.__h, a = t.__e = n.__e, t.__h = null, s = [a]), (l = ge.__b) && l(t);
        try {
            e: if ("function" == typeof v) {
                if (m = t.props, p = (l = v.contextType) && o[l.__c], b = l ? p ? p.props.value : l.__ : o, n.__c ? f = (h = t.__c = n.__c).__ = h.__E : ("prototype" in v && v.prototype.render ? t.__c = h = new v(m, b) : (t.__c = h = new ke(m, b), h.constructor = v, h.render = ze), p && p.sub(h), h.props = m, h.state || (h.state = {}), h.context = b, h.__n = o, d = h.__d = !0, h.__h = []), null == h.__s && (h.__s = h.state), null != v.getDerivedStateFromProps && (h.__s == h.state && (h.__s = Ce({}, h.__s)), Ce(h.__s, v.getDerivedStateFromProps(m, h.__s))), u = h.props, g = h.state, d) null == v.getDerivedStateFromProps && null != h.componentWillMount && h.componentWillMount(), null != h.componentDidMount && h.__h.push(h.componentDidMount);
                else {
                ...
                h.context = b, h.props = m, h.state = h.__s, (l = ge.__r) && l(t), h.__d = !1, h.__v = t, h.__P = e, l = h.render(h.props, h.state, h.context), h.state = h.__s, null != h.getChildContext && (o = Ce(Ce({}, o), h.getChildContext())), d || null == h.getSnapshotBeforeUpdate || (_ = h.getSnapshotBeforeUpdate(u, g)), y = null != l && l.type === Te && null == l.key ? l.props.children : l, Le(e, Array.isArray(y) ? y : [y], t, n, o, i, s, r, a, c), h.base = t.__e, t.__h = null, h.__h.length && r.push(h), f && (h.__E = h.__ = null), h.__e = !1
            } else null == s && t.__v === n.__v ? (t.__k = n.__k, t.__e = n.__e) : t.__e = Ye(n.__e, t, n, o, i, s, r, c);
            (l = ge.diffed) && l(t)
        }
        catch (e) {
            t.__v = null, (c || null != s) && (t.__e = a, t.__h = !!c, s[s.indexOf(a)] = null), ge.__e(e, t, n)
        }
    }

    function Fe(e, t) {
        ge.__c && ge.__c(t, e), e.some((function(t) {
            try {
    ...
    function Ye(e, t, n, o, i, s, r, a) {
        ...
        if (null === g) d === u || a && e.data === u || (e.data = u);
            ...
            if (s = s && ue.call(e.childNodes), l = (d = n.props || be).dangerouslySetInnerHTML, h = u.dangerouslySetInnerHTML, !a) {
                if (null != s)
            ...
            else if (_ = t.props.children, Le(e, Array.isArray(_) ? _ : [_], t, n, o, i && "foreignObject" !== g, s, r, s ? s[0] : n.__k && Oe(n, 0), a), null != s)
                for (_ = s.length; _--;) null != s[_] && xe(s[_]);
            a || ("value" in u && void 0 !== (_ = u.value) && (_ !== e.value || "progress" === g && !_ || "option" === g && _ !== d.value) && De(e, "value", _, d.value, !1), "checked" in u && void 0 !== (_ = u.checked) && _ !== e.checked && De(e, "checked", _, d.checked, !1))
        }
        return e
    }
    ...
    function He(e, t, n) {
        var o, i;
        if (ge.unmount && ge.unmount(e), (o = e.ref) && (o.current && o.current !== e.__e || Ve(o, null, t)), null != (o = e.__c)) {
        ...
        if (o = e.__k)
            for (i = 0; i < o.length; i++) o[i] && He(o[i], t, "function" != typeof e.type);
    ...
    function We(e, t, n) {
        var o, i, s;
        ge.__ && ge.__(e, t), i = (o = "function" == typeof n) ? null : n && n.__k || t.__k, s = [], Ue(t, e = (!o && n || t).__k = Se(Te, null, [e]), i || be, be, void 0 !== t.ownerSVGElement, !o && n ? [n] : i ? null : t.firstChild ? ue.call(t.childNodes) : null, s, !o && n ? n : i ? i.__e : t.firstChild, o), Fe(s, e)
    }
    ue = ye.slice, ge = {
            __e: function(e, t) {
        ...
        function(e) {
            ...
            var n;
            n = null != this.__s && this.__s !== this.state ? this.__s : this.__s = Ce({}, this.state), "function" == typeof e && (e = e(Ce({}, n), this.props)), e && Ce(n, e), null != e && this.__v && (t && this.__h.push(t), Ie(this))
        }, ke.prototype.forceUpdate = function(e) {
            this.__v && (this.__e = !0, e && this.__h.push(e), Ie(this))
        }, ke.prototype.render = Te, fe = [], me = "function" == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, Ae.__r = 0, 0;
    var $e, qe, Ke, je = 0,
        Je = [],
        Qe = ge.__b,
        Ze = ge.__r,
    ...
    function it(e, t, n) {
        var o = nt($e++, 2);
        return o.t = e, o.__c || (o.__ = [n ? n(t) : gt(void 0, t), function(e) {
            var t = o.t(o.__[0], e);
    ...
    ge.__b = function(e) {
        ...
        Xe && Xe(e);
        var t = e.__c;
        t && t.__H && t.__H.__h.length && (1 !== Je.push(t) && Ke === ge.requestAnimationFrame || ((Ke = ge.requestAnimationFrame) || function(e) {
            var t, n = function() {
                    clearTimeout(o), lt && cancelAnimationFrame(t), setTimeout(e)
                },
                o = setTimeout(n, 100);
        ...
        t.some((function(e) {
            try {
                e.__h.forEach(ht), e.__h = e.__h.filter((function(e) {
                    return !e.__ || dt(e)
                }))
            } catch (n) {
                t.some((function(e) {
    ...
    function bt({
        ...
        const g = r ? -1 : 0,
            ...
            p = f === J.OPT_IN || f === J.OPT_OUT || f === J.OPT_OUT_BY_CATEGORY || f === J.COOKIES_BY_CATEGORY;
        return ft("div", {
            id: u,
    ...
    function xt({
        ...
        const [s, r] = ot(!1), a = e === p.NECESSARY, c = rt(null), l = rt(null), h = () => {
            r(!s)
        };
        st(() => {
            if (s) {
                const e = c.current;
                e && e.scrollIntoView && !Ct(e, i.current) && e.scrollIntoView({
                    behavior: "smooth"
                })
            }
        }, [s, i, c]);
            ...
            children: [ft("div", {
                ...
                children: [ft("button", {
                    ...
                    children: [ft(vt, {
                        ...
                        dangerouslySetInnerHTML: W(n.label)
                    })]
                }), !a && ft(yt, {
                    category: e,
    ...
    function At({
        ...
        const [h, d] = ot(t.categories.analytics), [u, g] = ot(t.categories.advertisement), [_, b] = ot(t.categories.functionality), y = () => {
            i({
                [p.ANALYTICS]: h,
                [p.ADVERTISEMENT]: u,
                [p.FUNCTIONALITY]: _
    ...
    var Bt = ["helvetica", "arial", "arial-black", "verdana", "tahoma", "trebuchet ms", "impact", "times new roman", "georgia", "palatino", "courier", "comic sans ms", "courier new", "sans-serif", "system-ui"];
    ...
    const Yt = {
        ...
        jt = (e, t) => Ht(t) ? [] : [...Wt(`--hs-banner-${e}-color`, t.color), ...Wt(`--hs-banner-${e}-text-color`, t.textColor), ...Wt(`--hs-banner-${e}-border-color`, t.borderColor)],
        Jt = e => Ht(e) ? [] : [{
        ...
        en = e => [...Wt("--hs-banner-accentColor", e.accentColor), ...Qt(e.position.getValue()), ...Jt(e.showCloseButton)],
        tn = e => {
            const t = {};
            if (!e) return t;
            const n = e.indexOf("-"),
    ...
    var nn = n(3);
    const on = e => e.stack ? nn.parse(e.stack).map(e => ({
            filename: e.file,
        ...
        dn = () => "10000000-1000-4000-8000-100000000000".replace(/[018]/g, e => (e ^ crypto.getRandomValues(new Uint8Array(1))[0] & 15 >> e / 4).toString(16)),
        ...
        mn = (e, t) => {
            const n = e instanceof Error ? e : new Error(String(e)),
                o = _n(n, an, cn, t || {});
            fn(`${gn(cn,an)}/cookie-banner-v2/raw/error.gif?url=${o.request.url}\n    &report=${encodeURIComponent(JSON.stringify(o))}`)
        },
        pn = (e, t) => {
            try {
                e()
        ...
        vn = () => window.performance.now ? Math.round(window.performance.now()) : void 0,
        Cn = (e, t, n) => {
            try {
    ...
    class In {
        ...
        removeDeprecatedBannerCookies() {
            this.cookie.get(de.OPT_OUT_COOKIE.getName()) && this.cookie.remove(de.OPT_OUT_COOKIE.getName());
            this.cookie.get(de.INITIAL_OPT_IN.getName()) && this.cookie.remove(de.INITIAL_OPT_IN.getName())
        }
        run() {
        ...
        shouldScanningOverride() {
            return [J.OPT_OUT, J.OPT_OUT_BY_CATEGORY, J.COOKIES_BY_CATEGORY, J.OPT_IN, J.NOTIFY].includes(this.matchedSetting.policy.type) && this.context.getWindow()[c]
        }
        shouldGpcOverride() {
        ...
        setBannerSettings(e) {
            (e[this.context.getLocation().hostname] || []).forEach(e => this.bannerSettings.push(X.fromJS(e)));
        ...
        getCurrentGeoLocation() {
            ...
            return kn(this.apiBaseUrl).then(t => {
        ...
        setConsentCookie() {
            ...
            e !== J.NO_COOKIES && e !== J.COOKIES_WITHOUT_BANNER && e !== J.NOTIFY && this.cookie.set(de.CATEGORY_PREFERENCE_COOKIE.getName(), this.consent.toCookieString(), {
        ...
        renderGpcBanner() {
            this.bannerParentElement = Mt(this.apiBaseUrl, this.context, this.matchedSetting, this.getRenderStyles(), this.dismissGpcBanner.bind(this), this.styleOverrides && this.styleOverrides.fontFamily);
            Cn(this.context.getWindow(), "bannerRendered", !0);
            this.sendViewActivity()
        }
        renderBanner() {
            this.bannerParentElement = Gt(this.apiBaseUrl, this.consent, this.matchedSetting, this.getRenderStyles(), this.context, this.setConsent.bind(this), this.hideBanner.bind(this), this.dismissNotifyBanner.bind(this), this.styleOverrides && this.styleOverrides.fontFamily);
            Cn(this.context.getWindow(), "bannerRendered", !0);
            this.sendViewActivity()
        }
        hideBanner() {
        ...
        showBanner() {
            if (this.matchedSetting.policy.type === J.NO_COOKIES || this.matchedSetting.policy.type === J.COOKIES_WITHOUT_BANNER) return;
        ...
        revokeCookieConsent() {
            [de.INITIAL_OPT_IN.getName(), de.OPT_OUT_COOKIE.getName(), de.CATEGORY_PREFERENCE_COOKIE.getName(), de.GPC_BANNER_DISMISS_COOKIE.getName(), de.NOTIFY_BANNER_DIMISS_COOKIE.getName(), "__hssc", "__hssrc", "__hstc", "__hs_do_not_track", "hubspotutk", "messagesUtk"].forEach(e => this.cookie.remove(e));
    ...
    function Rn(e, t) {
        ...
        "loading" === o.readyState ? o.addEventListener("DOMContentLoaded", i) : Bn(e, t)
    }
    const Pn = L();
    pn(() => {
        Rn(Pn, mn)
...
/****** Cookie Banner version static-1.2131 *****/