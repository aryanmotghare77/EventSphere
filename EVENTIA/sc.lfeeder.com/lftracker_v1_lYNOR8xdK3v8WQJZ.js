! function() {
    ...
    if ("undefined" != typeof window && void 0 !== window.ldfdr) {
        ...
        var t = function() {
            ...
            r = (n = window.ldfdr, e = k, j = J, t = t, n.setTrackerOption(e, "lfaCookieEnabled", !0, t.enableCookie), n.setTrackerOption(e, "consentManagementEnabled", !1, t.enableCm), n.setTrackerOption(e, "useSendBeaconApi", !1, t.useBeacon), n.setTrackerOption(e, "autoTrackingMode", "spa", t.atMode), n.setTrackerOption(e, "foreignCookieSettings", {
                ...
                fields: [{
                    ...
                    "nameRegex": "email_read_only",
                    "type": "email",
                    "lfProperty": "email"
                }, {
                    "nameRegex": "event_account\\[email\\]",
                    "type": "email",
                    "lfProperty": "email"
                }, {
                    "nameRegex": "firstname",
                    ...
                    "nameRegex": "form_fields\\[email\\]",
                    "type": "email",
                    "lfProperty": "email"
                }, {
                    "nameRegex": "form_fields\\[field_((([a-f0-9]{4,}|[0-9]{3,})-?)+|###+)\\]",
                    "type": "email",
                    "lfProperty": "email"
                }, {
                    "nameRegex": "form_fields\\[field_((([a-f0-9]{4,}|[0-9]{3,})-?)+|###+)\\]",
    ...
    d() && y().registerPlugin(k, "discover", function() {
        var n = y().getTracker(k).plugins.discover.config;
        (n = n).jsConnectorConfigs && 0 !== n.jsConnectorConfigs.length && Ae(n.jsConnectorConfigs.map(function(e) {
            return function(n) {
                V(e, n)
            }
        }), 0)
    }), d() && y().registerPlugin(k, "file-downloads", function() {
        var o = y().getTracker(k),
        ...
        function n() {
            for (var n = document.getElementsByTagName("a"), e = 0; e < n.length; e++) {
                var t, r = n[e];
                !(r.getAttribute("href") + "").match(i.filesToMatch) || r.getAttribute(t = "data-lf-fd-inspected-" + k) || (r.setAttribute(t, "true"), a(r))
            }
        }
        i.filesEnabled && (n(), M(n))
    }), d() && y().registerPlugin(k, "form-tracking", function() {
        var n, e, t, r = 500,
            u = ["button", "hidden", "image", "password", "reset", "submit"],
            f = ["card", "credit", "cvv", "cvc"],
            l = /^(?:(4[0-9]{12}(?:[0-9]{3})?)|(5[1-5][0-9]{14})|(6(?:011|5[0-9]{2})[0-9]{12})|(3[47][0-9]{13})|(3(?:0[0-5]|[68][0-9])[0-9]{11})|((?:2131|1800|35[0-9]{3})[0-9]{11}))$/,
            i = 0,
            o = y().getTracker(k),
            s = (n = o.plugins["form-tracking"].config, e = (n.fields || []).map(function(n) {
                return {
        ...
        function d(n) {
            ...
            t && -1 == (e = ((e = n).innerText || e.value || "").toLowerCase()).indexOf("prev") && -1 == e.indexOf("next") && (e = n.form || n.closest("form")) && w(e, t)
        }
        ...
        function p(r) {
            ...
            return s.excluded.some(function(n) {
                return g(i, n.pageUrl) || function(n, e) {
                    if (e.inputName)
                        for (var t = n.elements, r = 0; r < t.length; r++)
                            if (g(t[r].name, e.inputName)) return !0;
                    return !1
                }(r, n) || g(r.id, n.formId) || (e = r, !!(t = n).formClass && e.className.split(/\s+/).some(function(n) {
                    return g(n, t.formClass)
                }));
                var e, t
            })
        }
        ...
        function w(n, e) {
            if (!(p(n) || i + r >= (new Date).getTime())) {
                var t = function(n) {
                    for (var e = {}, t = n.elements, r = s.fields ? s.fields.filter(function(n) {
                            return !!n.lfProperty
                        }) : [], i = 0; i < t.length; i++) {
                        var o = t[i],
                            a = o.name,
                        ...
                        !a || function(n) {
                            if (0 <= u.indexOf(n.type)) return 1;
                            for (var e = 0; e < f.length; e++)
                                if (0 <= n.name.toLowerCase().indexOf(f[e])) return 1;
                            return n.value && l.test(n.value.replace(/\-| /g, ""))
                        }(o) || c || (e[a] = {
                            name: a,
                            type: o.type
                        }, function(n) {
                            ...
                            switch (s.formTrackingMode) {
                                case "configured_fields":
                                    return s.fields.some(function(n) {
                                        return v(e, n)
                                    });
                ...
                if (t && 0 != t.length) {
                    ...
                    try {
                        o.track(function(n, e, t) {
                            var e = {
                                    formTrackingMode: s.formTrackingMode,
                                    formEventType: e
                                },
                                r = n.getAttribute("id"),
        ...
        function m(n) {
            try {
                n.contentDocument && (n.contentDocument.addEventListener("submit", a), n.contentDocument.addEventListener("click", d, !0))
            } catch (n) {}
        }

        function h() {
            for (var n = document.getElementsByTagName("iframe"), e = 0; e < n.length; e++) ! function(n) {
                var e = "data-lf-form-tracking-inspected-" + k;
                n.getAttribute(e) || (n.setAttribute(e, "true"), m(n), n.addEventListener("load", function() {
                    m(n)
                }))
            }(n[e])
        }
        switch (s.formTrackingMode) {
            ...
            case "configured_fields":
            case "all_but_excluded":
                return document.addEventListener("submit", a), document.addEventListener("click", d, !0), h(), void M(h);
            default:
                return
        }
    });
        ...
        setTimeout(function() {
            ...
            n = o.ga_id, e = function(i) {
                ...
                _n(o.api_key, function(n) {
                    ...
                    e = i, t = o.ga_id, n = n, r = l(window), null !== n && (r((e = e.get("name")) + ".set", n), r(e + ".send", {
                        hitType: "event",
                        eventCategory: H,
                        eventAction: X,
                        nonInteraction: !0
            ...
            }, t = n.toLowerCase(), l(window)(function() {
                if (void 0 === l(window).getAll) return e(null);
                var n = l(window).getAll().filter(function(n) {
    ...
    function rn(n) {
        (l(window) || En(window) || f(window)) && (clearInterval(Y), Ae(n.map(function(t) {
            return function(n) {
                var e;
    ...
    window[$] = [], d() && y().registerPlugin(k, "ga-connector", function() {
        var n, e = y().getTracker(k).plugins["ga-connector"].config;
        (n = e).gaConnectorSettings && 0 !== n.gaConnectorSettings.length && (Y = setInterval(function() {
            rn(n.gaConnectorSettings)
        }, 300), setTimeout(function() {
            clearInterval(Y)
        }, 1e4))
    }), d() && y().registerPlugin(k, "intercom-tracking", function() {
        var n, e, t, r, i, o, a = y().getTracker(k);
    ...
    function dn() {
        ...
        if (n.length)
            for (var e = 0; e < n.length; e++) {
                var t = n[e],
                    r = "data-lf-vimeo-playback-inspected-" + k;
                t.getAttribute(r) || (t.setAttribute(r, "true"), sn(t), t.addEventListener("load", function() {
                    sn(t)
                }))
            }
    }
    d() && y().registerPlugin(k, "spa-tracking", function() {
        var n = y().getTracker(k);
        n = n, an = window.location.href, "spa" === n.autoTrackingMode && cn(n)
    }), d() && y().registerPlugin(k, "vimeo-playback", function() {
        var e, t = y().getTracker(k);
    ...
    }), d() && y().registerPlugin(k, "yt-playback", function() {
        var o, e, i, a, t = y().getTracker(k);
        ...
        function n() {
            ...
            if (n.length) {
                ...
                for (var e = 0; e < n.length; e++) {
                    var t = n[e],
                        r = "data-lf-yt-playback-inspected-" + k;
        ...
        function c(n, e) {
            if (function(n) {
                ...
                var t, r;
                if (-1 === n.src.indexOf("autoplay=1")) return -1 === n.src.indexOf("enablejsapi") ? (r = -1 === (t = n).src.indexOf("?") ? "?" : "&", r = (r += "enablejsapi=1") + "&origin=" + window.location.origin, t.src = t.src + r) : (t = n, r = e, void(("undefined" == typeof YT || "function" == typeof YT.get && t.id && void 0 === YT.get(t.id)) && (s(o[r] = t, {
                    event: "listening",
                    id: r,
                    channel: "widget"
                }), s(t, {
        ...
        function u(n) {
            var e = f(n.src);
            e.tracked || (e.tracked = !0, n = "https://www.youtube.com/watch?v=" + l(n), t.track({
                eventType: "video-start",
                properties: {
                    videoUrl: n,
    ...
    function pn() {
        var n;
        n = (new Date).getTime() + gn, y().suppressUnloadUntil = n
    }

    function wn() {
        var n = new Date,
            e = y().suppressUnloadUntil;
        if (!(e < n.getTime()))
            for (; e >= n.getTime(); 0) n = new Date
    }!d() || "suppressUnloadUntil" in y() || (y().suppressUnloadUntil = 0, window.addEventListener("beforeunload", wn, !1));
    var vn, mn = "_lfa",
        hn = 5;
    ...
    function Nn() {
        for (var n = 0, e = [], t = (window.dataLayer || []).filter(function(n) {
                ...
                return n[1]
            }), r = Object.keys(f(window)).filter(On), n = 0; n < t.length; n++) s(t[n], e);
    ...
    function An() {
        ...
        if (null !== l(window))
            for (var t = window, r = e, i = !(t = l(t)) || "function" != typeof t.getAll ? [] : t.getAll(), o = 0; o < i.length; o++) s(i[o].get("clientId"), r.clientIds), s(i[o].get("trackingId"), r.trackingIds);
        else
            for (var t = window, a = e, c = !(t = Sn(t)) || "function" != typeof t._getTrackers ? [] : t._getTrackers(), u = 0; u < c.length; u++) s(c[u]._getAccount(), a.trackingIds, !0);
    ...
    function Fn() {
        return function() {
            ...
            if (!_()) return 0;
            var n = window.localStorage.getItem(m);
            if (null == n) return 0;
    ...
    function Bn(n, e) {
        return n && R(n, h) || (n = qn(Ne())), jn(m, n, e), n
    }
    ...
    function fe() {
        var n;
        return ee(N()) ? Bn(ne(), ue()) : (Fn() && setTimeout(le, 1e3), A(N()) && S !== p ? (window[xn] || (n = qn(Ne()) + ".CM", window[xn] = n), window[xn]) : h + "." + Ne() + ".NC")
    }

    function le() {
        !Fn() || ! function() {
            for (var n = 0, e = y().getAll(); n < e.length; n++)
                if (ee(e[n])) return;
            return 1
        }() || Rn()
    }
    ...
    function se(n) {
        ...
        return e = window, null !== (t = l(e)) && "function" == typeof t && "function" == typeof t.getAll || null !== (t = Sn(e)) && "object" == typeof t && "function" == typeof t._getTrackers || i ? n() : (setTimeout(function() {
            return se(n)
    ...
    function de(e, t) {
        ! function(n) {
            ...
            var n = ie(ve(), e);
            !0 === N().useSendBeaconApi && navigator && navigator.sendBeacon ? (ae("https://tr.lfeeder.com", n, t), re() && ae("https://tr2.lfeeder.com", n)) : (ce("https://tr.lfeeder.com", n, t), re() && ce("https://tr2.lfeeder.com", n))
        })
    }
    ...
    function Te() {
        for (var n, e = y().registerTracker(k, de, pe, we, ve, me, he), t = e, r = t.getPlugins(), i = 0; i < r.length; i++) {
            var o = r[i];
    ...
    function Ne() {
        return function(n) {
            ...
            for (k.push(d >>> 29), k.push(d << 3 & 4294967295), r = 0; r < k.length; r += 16) {
                ...
                for (a = p, c = w, u = v, f = m, l = h, i = 0; i <= 19; i++) s = e(a, 5) + (c & u | ~c & f) + l + g[i] + 1518500249 & 4294967295, l = f, f = u, u = e(c, 30), c = a, a = s;
                for (i = 20; i <= 39; i++) s = e(a, 5) + (c ^ u ^ f) + l + g[i] + 1859775393 & 4294967295, l = f, f = u, u = e(c, 30), c = a, a = s;
                for (i = 40; i <= 59; i++) s = e(a, 5) + (c & u | c & f | u & f) + l + g[i] + 2400959708 & 4294967295, l = f, f = u, u = e(c, 30), c = a, a = s;
                for (i = 60; i <= 79; i++) s = e(a, 5) + (c ^ u ^ f) + l + g[i] + 3395469782 & 4294967295, l = f, f = u, u = e(c, 30), c = a, a = s;
                p = p + a & 4294967295, w = w + c & 4294967295, v = v + u & 4294967295, m = m + f & 4294967295, h = h + l & 4294967295
            }
    ...
    function xe(t, r, i) {
        function o() {
            l = !1 === i.leading ? 0 : (new Date).getTime(), a = null, f = t.apply(c, u), a || (c = u = null)
        }

        function n() {
            var n = (new Date).getTime(),
                e = (l || !1 !== i.leading || (l = n), r - (n - l));
            return c = this, u = arguments, e <= 0 || r < e ? (a && (clearTimeout(a), a = null), l = n, f = t.apply(c, u), a || (c = u = null)) : a || !1 === i.trailing || (a = setTimeout(o, e)), f
        }
        var a, c, u, f, l = 0;
        i = i || {};
